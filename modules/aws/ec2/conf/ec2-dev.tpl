...
sudo ansible-playbook deployment.yaml -e stack_name=${stack} -e message=${server_name} -e instance_id=${server_name} -e cloudwatch_log_group=${cloudwatch_log_group} -e log_file_path=${log_file_path} -v >> /var/log/user-data.log 2>&1
