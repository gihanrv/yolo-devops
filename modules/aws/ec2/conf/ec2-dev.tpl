...
sudo mkdir -p /tmp/${git-repo-name} && sudo git clone -b master https://github.com/gihanrv/yolo-devops.git /tmp/${git-repo-name}
sudo mkdir -p /tmp/${git-repo-name} && sudo git clone -b ${git_branch} ${git_repo_url} /tmp/${git-repo-name}